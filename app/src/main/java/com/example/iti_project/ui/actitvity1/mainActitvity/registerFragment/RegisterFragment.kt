...
class RegisterFragment : Fragment() {
    ...
    // UserViewModelFactory(UserRepositoryImplementation(AppDataBase.getInstance(requireContext())))
        ...
        btn_create_account.setOnClickListener {
            ...
            if (isValid) {
                ...
                if (isEmailUnique) {
                    ...
                    val isInsert = registerFragmentViewModel.insertData(userName, email, password)
                    if (isInsert) {
                        val action =
